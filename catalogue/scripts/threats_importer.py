...
# This script lives at  catalogue/scripts/threats_importer.py
...
def _find_paths() -> tuple[Path, Path]:
    ...
    # Ensure the api/ sibling is on sys.path so `from app.models...` works
    # when invoked from the host (context 1/3).
